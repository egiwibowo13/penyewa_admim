  ...
  constructor(private http:Http, private route:ActivatedRoute) {  }
    ...
    createDataSewa(dataSewa){
      ...
      // }else{
        ...
        let x = dataSewa.KdDataSewa;
        let y = dataSewa.UserNamePegawai;
        let z = dataSewa.UserNamePenyewa;
        let a = dataSewa.KdBarang;
        let b = dataSewa.StatusDataSewa;
        let c = dataSewa.TglMulai;
        let d = dataSewa.TglSelesai;
        let e = dataSewa.JumlahBarang;
